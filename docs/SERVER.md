...
The full relay source code is available in the [`Relay/`](Relay) directory. This option has no restrictions whatsoever and is the preferred approach — you stay in full control of your infrastructure and there are no dependencies on third-party availability.
